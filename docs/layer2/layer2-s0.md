...
### [Appendix A — Standards Bridge: OpenTravel / NDC](./layer2-app-a)
...
This specification is a **Working Draft**. All sections (S1–S12 and Appendix A) have been validated as working drafts. S0 (this document) completes the Layer 2 specification set. The specification will advance to Candidate Specification status following review by the founding consortium.
