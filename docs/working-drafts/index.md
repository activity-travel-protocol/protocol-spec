...
**Working Draft**  Einternal design and review documents. Not yet normative. Published for transparency and community review.

**Specification Preview**  Esubstantially complete specifications. Normative for implementation purposes. Subject to editorial revision before final ratification.
...
| [MCP Server Addendum  EWindley Loop](./mcp-server-addendum) | `@atp/mcp-server` | Windley Loop pre-session policy query (normative, v1.0). Re-query triggers and escalation precision. Closes MCP-D13–MCP-D15. |
...
|---|---|
| [Foundation Charter](./foundation-charter) | Governing document of the Activity Travel Protocol Foundation (一般社団法人アクチE��ビティトラベルプロトコールファウンチE�Eション). Purpose, membership model, TSC composition, decision process, amendment rules. |
...
| [Context Package  EDesign Rationale](./context-package-design) | Working Draft | Design rationale for Context Package schema decisions. |
| [Traveller Identity ? Party Registry v0.3](./party-registry-v03-traveller-identity) | Working Draft | TRAVELLER party type, consumer authentication (OIDC, OTP, Passkey), Traveller Identity Token schema, traveller AI Agent mandate constraints (Level 2 ceiling), consent records. Closes OQ-MOB-1, OQ-MOB-2, OQ-MOB-3. |

---

*Activity Travel Protocol  EWorking Drafts & Specification Preview  EApril 2026*\
*Apache 2.0  EActivity Travel Protocol Foundation (in formation / 設立準備中)*
