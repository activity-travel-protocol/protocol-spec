...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Governed by the <a href="https://activitytravel.org/governance.html">Activity Travel Protocol Foundation (in formation)</a> · Released under Apache 2.0'
    },
    editLink: {
