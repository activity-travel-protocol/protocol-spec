  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/working-drafts/': [{ text: 'Working Drafts', items: [
        ...
        { text: 'Traveller Identity ? Party Registry v0.3', link: '/working-drafts/party-registry-v03-traveller-identity' }
      ]}],
    ...
    footer: {
      ...
      copyright: 'Governed by the Activity Travel Protocol Foundation ÅE Released under Apache 2.0'
    },
    editLink: {
